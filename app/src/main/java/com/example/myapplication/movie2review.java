...
public class movie2review extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.movie1:
                startActivity(new Intent(movie2review.this, TimingsScreen.class));
                break;
            case R.id.movie1bookbtn:
                startActivity(new Intent(movie2review.this, Bookseats.class));
                break;
        }
    }
}