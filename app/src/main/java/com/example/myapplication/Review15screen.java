...
public class Review15screen  extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_review15screen);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.moviebookbtn:
                startActivity(new Intent(Review15screen.this, TimingsScreen.class));
                break;
        }
