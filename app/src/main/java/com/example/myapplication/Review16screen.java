...
public class Review16screen  extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_review16screen);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.moviebookbtn:
                startActivity(new Intent(Review16screen.this, TimingsScreen.class));
                break;
        }
