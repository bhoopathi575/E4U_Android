...
public class Review14screen  extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_review14screen);
        ...
        imgView.setImageResource(R.drawable.movie14);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.moviebookbtn:
                startActivity(new Intent(Review14screen.this, TimingsScreen.class));
                break;
        }
