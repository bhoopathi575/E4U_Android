...
public class Review2screen  extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_review2screen);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.moviebookbtn:
                startActivity(new Intent(Review2screen.this, Bookseats.class));
                break;
        }
