...
public class Review4screen  extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.moviebookbtn:
                startActivity(new Intent(Review4screen.this, TimingsScreen.class));
                break;
        }
